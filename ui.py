...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_label.config(padx=20, pady=20, bg=THEME_COLOR, fg="white", font=("Arial", 16, "bold"))
        # ----------- Row 1 ---------- #
        ...
        self.true_button = tkinter.Button(image=self.true_image, command=self.true_pressed)
        self.true_button.grid(row=2, column=0, padx=20, pady=20)
        self.false_image = tkinter.PhotoImage(file="images/false.png")
        self.false_button = tkinter.Button(image=self.false_image, command=self.false_pressed)
